...
def launch_setup(context):
    ...
    # In offline mode, vocal_detect_launch and agent_process_launch are delayed by 10
    # seconds (local model load time); in online mode they are delayed by 1 second,
    # and tts_node_launch starts immediately.
